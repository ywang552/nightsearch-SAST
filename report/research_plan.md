...
This plan is intended to be grounded by Zhang's PDF (`13059_2025_3608_MOESM1_ESM.pdf`) and Youchuan Wang's statement PDF (`research_statement_template.pdf`). In this runtime, those files were not present in the repository/container, so this draft is marked provisional and should be revised after direct PDF extraction.
