...
|---|---|---|---|---|---|---|
| Add report hygiene checker to CI | Ensure Markdown report policies are validated in automation with low runtime cost. | P1 | done | none | hygiene | Workflow runs `scripts/check_report_hygiene.py` and fails on policy violations. |
